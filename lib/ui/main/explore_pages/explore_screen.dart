                              ...
                              CarouselSlider(
                                ...
                                items: controller.allData.map((item) {
                                  return GestureDetector(
                                    onTap: () {
                                      ...
                                      //   context,
                                      //   screen: AnimeDetailScreen(data: controller.allData[
                                      //           controller.allData.indexOf(item)],
                                ...
                                options: CarouselOptions(
                                  onPageChanged: (index, reason) {
                                    favController.updateCurrentItem(index);
                                  },
                              ...
                              Container(
                                ...
                                child: GetBuilder<FavController>(
                                  builder: (controller1) => GestureDetector(
                                    onTap: () {
                                      int currentItemId = controller.allData[
                                          favController.currentItem]['id'];

                                      if (controller1.favDataId
                                          .contains(currentItemId)) {
                                        controller1.removeFromFav(
                                            controller.allData[
                                                favController.currentItem]);
                                      } else {
                                        controller1.addToFav(controller.allData[
                                            favController.currentItem]);
                                      }
                                    },
                                    child: controller1.favDataId.contains(
                                            controller.allData[favController
                                                .currentItem]['id'])
                                        ? const Icon(
                                            Icons.favorite,
                                            color: red,
